...
<div id="app">
  ...
  <form id="form">
    ...
    <section>
      <h2>UVM library</h2>
      <div class="tip">
        A friendlier view over the same <code>flags</code> string above: point slang at your
        UVM library so its packages and macros resolve. Nothing here is UVM-specific to the
        server -- these become ordinary <code>-I</code> and file arguments.
      </div>
      <div id="uvm-fields">
        <div class="field">
