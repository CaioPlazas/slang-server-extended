  ...
  implements TreeDataProvider<HierItem>, vscode.TerminalLinkProvider<InstanceLink>
{
  ...
  openServerConfig: CommandNode = new CommandNode(
    {
      title: 'Configure Slang',
      shortTitle: 'Configure',
    },
    async () => {
      await ServerConfigPanel.createOrShow()
    }
  )
  ...
  constructor() {
    super({
      ...
      welcome: {
        contents:
          '[Select Build File](command:slangCustom.project.selectBuildFile)\n[Select Top Level](command:slangCustom.project.selectTopLevel)\n[Configure Slang](command:slangCustom.project.openServerConfig)',
      },
    })
  }
  ...
  private decorateHierarchyTreeItem(item: TreeItem, element: HierItem): TreeItem {
    ...
    item.command = {
      ...
      command: 'slangCustom.project.setInstance',
