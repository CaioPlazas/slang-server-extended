...
remote resolves the universal package — which, up to v0.5.3, contained no server at all and
prompted you to download one. The binary is Linux x86-64 either way; on macOS and Windows it is
