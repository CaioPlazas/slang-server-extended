...
This is [CaioPlazas/slang-server](https://github.com/CaioPlazas/slang-server), a fork of
...
- Grab `slang-server-extended-linux-x64.vsix` from the [Releases page](https://github.com/CaioPlazas/slang-server/releases)
...
Latest builds (including betas): [Releases](https://github.com/CaioPlazas/slang-server/releases)
